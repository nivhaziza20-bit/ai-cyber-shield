...
(CFAA), Computer Misuse Act (CMA), or local equivalent laws.""",
    ...
    # ── Israeli Compliance (Brief 12) ────────────────────────────────────────
    "compliance_toggle_label":  {"he": "🇮🇱 כלול מיפוי רגולציה ישראלית",    "en": "🇮🇱 Include Israeli regulatory mapping"},
    "compliance_tab_title":     {"he": "התאמה לרגולציה ישראלית",            "en": "Israeli Regulatory Compliance"},
    "compliance_disclaimer":    {
        "he": "המיפוי שלהלן הוא אינדיקטיבי בלבד ואינו ייעוץ משפטי. לבדיקת חשיפה רגולטורית בפועל יש להיוועץ ביועץ משפטי המתמחה בדיני הגנת פרטיות ישראליים.",
        "en": "The mapping below is INDICATIVE ONLY and does NOT constitute legal advice. For actual regulatory exposure assessment, consult a qualified attorney specializing in Israeli privacy law.",
    },
    "compliance_direct_indicator":  {"he": "אינדיקטור ישיר",               "en": "Direct Indicator"},
    "compliance_related_context":   {"he": "הקשר קשור",                    "en": "Related Context"},
    "compliance_findings_count":    {"he": "{n} ממצאים עם מיפוי רגולטורי",  "en": "{n} findings with regulatory mapping"},
    "compliance_no_findings":       {"he": "לא נמצאו ממצאים עם מיפוי רגולטורי ישראלי", "en": "No findings mapped to Israeli regulations"},
    "compliance_pdf_export":        {"he": "📄 הורד דוח התאמה (PDF)",        "en": "📄 Download Compliance Report (PDF)"},
    "compliance_pdf_title":         {"he": "דוח התאמה רגולטורית",            "en": "Regulatory Compliance Report"},
    "compliance_regulation":        {"he": "תקנה",                          "en": "Regulation"},
    "compliance_section":           {"he": "סעיף",                          "en": "Section"},
    "compliance_requirement":       {"he": "דרישה",                         "en": "Requirement"},
    "compliance_confidence":        {"he": "רמת ביטחון",                    "en": "Confidence"},
    "compliance_action":            {"he": "פעולה מומלצת",                  "en": "Recommended Action"},
    "compliance_amendment13":       {"he": "תיקון 13 לחוק הגנת הפרטיות",   "en": "Amendment 13 to Privacy Protection Law"},
    "compliance_data_security_regs":{"he": "תקנות הגנת הפרטיות (אבטחת מידע)", "en": "Privacy Protection Regulations (Data Security)"},
    "severity_critical_he":         {"he": "קריטי",                         "en": "Critical"},
    "severity_high_he":             {"he": "גבוה",                          "en": "High"},
    "severity_medium_he":           {"he": "בינוני",                        "en": "Medium"},
    "severity_low_he":              {"he": "נמוך",                          "en": "Low"},
    "severity_info_he":             {"he": "מידע",                          "en": "Info"},
    "pdf_scan_date":                {"he": "תאריך סריקה",                   "en": "Scan Date"},
    "pdf_overall_score":            {"he": "ציון כולל",                     "en": "Overall Score"},
    "pdf_grade":                    {"he": "דירוג",                         "en": "Grade"},
    "pdf_executive_summary":        {"he": "סיכום מנהלים",                  "en": "Executive Summary"},
    "pdf_methodology":              {"he": "מתודולוגיה",                    "en": "Methodology"},
    "pdf_glossary":                 {"he": "מילון מונחים",                  "en": "Glossary"},
    "pdf_generated_by":             {"he": "הופק על ידי AI Cyber Shield",   "en": "Generated by AI Cyber Shield"},
